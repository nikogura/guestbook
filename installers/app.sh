...
# Default-Stop:      0 1 6
# Short-Description: Simple guest book application
...
echo "$INITSCRIPT" | sudo tee /etc/init.d/guestbook

sudo chmod 755 /etc/init.d/guestbook

sudo service guestbook start

sudo update-rc.d guestbook defaults
